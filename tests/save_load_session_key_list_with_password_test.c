...
int main(int argc, char* argv[]) {
    ...
    ret = symmetric_encrypt_authenticate(
        ...
        AES_128_CBC_IV_SIZE, AES_128_CTR, false, MAC_TYPE_SHA256, &encrypted,
        &encrypted_length);
    assert(ret == 0);
    ...
    ret = symmetric_decrypt_authenticate(
        ...
        AES_128_KEY_SIZE_IN_BYTES, AES_128_CBC_IV_SIZE, AES_128_CTR, false,
        MAC_TYPE_SHA256, &decrypted, &decrypted_length);
