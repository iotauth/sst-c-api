/**
 * @file encrypt_buf_with_session_key_without_malloc_execution_time_test.cpp
 * @author Dongha Kim
...
long get_time_diff_ns(std::chrono::high_resolution_clock::time_point start,
...
extern "C" {
    int main(int argc, char* argv[]) {
        ...
        std::chrono::high_resolution_clock::time_point start_outer, end_outer, start_inner, end_inner;
        long total_inner_time_ns = 0, total_outer_time_ns = 0;

        // Start measuring time for the outer loop
        start_outer = std::chrono::high_resolution_clock::now();
        ...
        end_outer = std::chrono::high_resolution_clock::now();
